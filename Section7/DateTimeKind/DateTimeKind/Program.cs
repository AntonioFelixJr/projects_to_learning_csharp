...
namespace DateTimeKind1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"d5.ToString(\"yyyy-mm-ddTHH:mm:sZ\") = {d5.ToString("yyyy-mm-ddTHH:mm:ssZ")}"); // cuidado!
            Console.WriteLine($"d5.ToUniversalTime().ToString(\"yyyy-mm-ddTHH:mm:ssZ\") = {d5.ToUniversalTime().ToString("yyyy-mm-ddTHH:mm:ssZ")}");
            Console.WriteLine("----------------------------------------------------------------------------------------");
        }
    }
}
